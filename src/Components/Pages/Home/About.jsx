...
const About = () => {
  return (
    <div className="  mx-auto px-8 sm:px-10 lg:px-16 py-28 dark:bg-gray-800 font  bg-gray-50">
      <div className="sm:text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800 dark:text-white text-center">About Us</h1>
      ...
      <div className="md:flex justify-between mb-20">
        <div className="flex justify-center items-center"><Lottie className="w-80" animationData={robo}></Lottie></div>
      ...
      <div className="mb-12">
        <h2 className="text-4xl font-semibold text-center  text-gray-800 dark:text-white">Our Values</h2>
        <p className="text-lg  mt-4 dark:text-white">
